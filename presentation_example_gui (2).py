...
flex_sensor_column = [[sg.Text("Flex Sensors", font=("Helvetica", 24))],
                      ...
                      [sg.Text("Sensor 4:"), sg.Text("0", key="f4")]]


imu_column = [[sg.Text("IMUs", font=("Helvetica", 24))],
              [sg.HorizontalSeparator()],
              ...
              [sg.Text("InternalImuAccX"), sg.Text("0", key="intAccX"),
               sg.Text("InternalImuAccY"), sg.Text("0", key="intAccY"),
               sg.Text("InternalImuAccZ"), sg.Text("0", key="intAccZ")],
              [sg.Text("InternalImuGyroX"), sg.Text("0", key="intGyroX"),
               sg.Text("InternalImuGyroY"), sg.Text("0", key="intGyroY"),
               sg.Text("InternalImuGyroZ"), sg.Text("0", key="intGyroZ")]]
...
while True:
    ...
    if (arduino.in_waiting):
        ...
        window["intAccX"].update(reading[19])
        window["intAccY"].update(reading[20])
        window["intAccZ"].update(reading[21])
        window["intGyroX"].update(reading[22])
        window["intGyroY"].update(reading[23])
        window["intGyroZ"].update(reading[24])
    time.sleep(0.1)
